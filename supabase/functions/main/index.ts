// Supabase self-hosted Edge Functions router (required at volumes/functions/main/index.ts).
// Without this file, leam-edge-functions crash-loops: "main worker boot error … entrypoint".
