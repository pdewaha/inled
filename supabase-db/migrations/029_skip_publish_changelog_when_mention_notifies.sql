-- When an expectation is published, receivers already get mention activity mail
-- ("You were added as a receiver…"). Skip duplicate changelog "Published this expectation."
...
COMMENT ON FUNCTION public.inled_enqueue_changelog_activity_emails() IS
  'Changelog activity mail; skips author on create; skips receivers on expectation create/publish when mention mail applies.';
