-- RPC must see/update placeholder rows; SECURITY DEFINER alone does not bypass RLS
-- unless the function owner is the table owner. SET row_security = off for the
-- function body (applied when owner is superuser / migration role — typical on beacon).
